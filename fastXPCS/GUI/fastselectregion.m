function varargout = fastselectregion(varargin)
% FASTSELECTREGION MATLAB code for fastselectregion.fig
%      FASTSELECTREGION, by itself, creates a new FASTSELECTREGION or raises the existing
%      singleton*.
%
%      H = FASTSELECTREGION returns the handle to a new FASTSELECTREGION or the handle to
%      the existing singleton*.
%
%      FASTSELECTREGION('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FASTSELECTREGION.M with the given input arguments.
%
%      FASTSELECTREGION('Property','Value',...) creates a new FASTSELECTREGION or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before fastselectregion_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to fastselectregion_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help fastselectregion

% Last Modified by GUIDE v2.5 12-Aug-2016 13:35:03

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @fastselectregion_OpeningFcn, ...
                   'gui_OutputFcn',  @fastselectregion_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before fastselectregion is made visible.
function fastselectregion_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to fastselectregion (see VARARGIN)

% Choose default command line output for fastselectregion
...
% UIWAIT makes fastselectregion wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = fastselectregion_OutputFcn(hObject, eventdata, handles) 
